...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style7">WELCOME TO OWNER :: <%= application.getAttribute("oname") %></h2>
          <p>&nbsp;</p>
          <p><img src="images/Architecture.png" width="558" height="177" /></p>
          <p>&nbsp;</p>
          <div class="clr"></div>
        </div>
        <p class="pages">&nbsp;</p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="ViewAllAuthorityFiles.jsp">View All Uploaded Files</a></li>
