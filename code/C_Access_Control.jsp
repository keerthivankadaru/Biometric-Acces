...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style7">C_Access_Control</h2>
          <p>&nbsp;</p>
...
<form action="FileBioIdentiry.jsp?id=<%=id1%>" method="post" id="sendemail" enctype="multipart/form-data">
            ...
            <p>&nbsp;            </p>
            <p align="center">
              <input name="Submit" type="submit" class="style5" value="Verify Finger Print and Give Access Control" />
            </p>
          </form>
