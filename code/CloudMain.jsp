    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost"><img src="images/Architecture.png" width="638" height="375" /></p>
          <div class="clr"></div>
        </div>
        </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="ViewClients.jsp">View All Owners and Authorize </a></li>
			<li><a href="D_ViewOwners.jsp">View All Clients and Authorize </a></li>
			...
			<li><a href="ViewResults.jsp">View File Score Results</a></li>
			<li><a href="C_ViewTDResults.jsp">View Time Delay Results</a></li>
			<li><a href="C_ViewTPTResults.jsp">View Throughput Results</a></li>
