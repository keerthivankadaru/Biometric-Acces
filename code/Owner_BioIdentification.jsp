...
<head>
<title>Client_BioIdentification</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style7">Client Bio Identification</h2>
          <p>&nbsp;</p>
          <form action="OBioIdentiry.jsp" method="post" id="sendemail" enctype="multipart/form-data">
            <ol><li><ol><ol><ol>
