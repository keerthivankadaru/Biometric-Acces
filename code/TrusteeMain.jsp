...
<head>
<title>Trusted Authority Main</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style7">WELCOME TO Authentication Server... </h2>
          <p class="infopost"><img src="images/Architecture.png" width="607" height="302" /></p>
          <div class="clr"></div>
        </div>
        </div>
      <div class="sidebar">
        <div class="gadget">
          <h2 class="star"><span>CA </span>Menu</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="TrusteeMain.jsp">Home</a></li>
			<li><a href="GenerateKey.jsp">Generate Private Key</a></li>
