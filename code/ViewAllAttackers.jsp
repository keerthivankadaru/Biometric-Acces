...
.style32 {font-size: 16px; color: #000000; font-weight: bold; font-style: italic; }
-->
</style>
</head>
<body>
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style16">View All Cloud Attackers </h2>
          <div class="clr"></div>
          <div class="img">
  ...
  <tr>
    <td width="140" height="32" bgcolor="#FFFF00"><div align="center" class="style22">Attacker Name </div></td>
      <td width="293" bgcolor="#FFFF00"><div align="center" class="style22">File Name </div></td>
    <td width="178" bgcolor="#FFFF00"><div align="center" class="style22">Secret Key Used </div></td>
...
<%
  ...
  <tr>
    <td height="29"><div align="center" class="style26 style25"><em><%=s2%></em></div></td>
    <td><div align="center" class="style32"><%=s3%></div></td>
	
	<td><div align="center" class="style32"><%=s4%></div></td>
    
	 <td><div align="center" class="style32"><%=s5%></div></td>
  </tr>
