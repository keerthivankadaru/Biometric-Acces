...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style16">View All Cloud Files </h2>
          <div class="clr"></div>
          <div class="img">
  ...
  <tr>
    <td width="140" height="32" bgcolor="#FFFF00"><div align="center" class="style22">File Name </div></td>
      <td width="293" bgcolor="#FFFF00"><div align="center" class="style22">Session Key  </div></td>
    <td width="178" bgcolor="#FFFF00"><div align="center" class="style22">Private Key </div></td>
    <td width="115" bgcolor="#FFFF00"><div align="center" class="style22">Rank </div></td>
    <td width="205" bgcolor="#FFFF00"><div align="center" class="style22">Date & Time</div></td>
	<td width="205" bgcolor="#FFFF00"><div align="center" class="style22">Access Authorization</div></td>
	<td width="205" bgcolor="#FFFF00"><div align="center" class="style22">File Owner</div></td>
  </tr>
...
<%
  ...
  <tr>
    <td height="29"><div align="center" class="style25 style26"><%=s2%></div></td>
    <td><div align="center" class="style31"><%=s3%></div></td>
	
	<td><div align="center" class="style31"><%=s4%></div></td>
    
	 <td><div align="center" class="style31"><%=s5%></div></td>
	  <td><div align="center" class="style31"><%=s6%></div></td>
	  <% if(s7.equals("No"))
	  {%>
	  <td><div align="center" class="style31"><a href="C_Access_Control.jsp?id=<%=i%>">Give Access Control</a></div></td>
	  <%}
	  else
	  {%>
	  <td><div align="center" class="style31"><%=s7%></div></td>
	  
	 <% }%>
	 <td><div align="center" class="style31"><%=s8%></div></td>
