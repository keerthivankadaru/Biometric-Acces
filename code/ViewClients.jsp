...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style16">View All Data Owners </h2>
          <div class="clr"></div>
          <div class="img">
            ...
            <tr>
              ...
              <td width="239" bgcolor="#FFFFFF"><div align="center" class="style23" >Data Owner  Name </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
              <td><div>
                  <div align="center"><a href="C_StatusClient.jsp?id=<%=i%>"><%=s5%></a></div>
              </div></td>
              <%
