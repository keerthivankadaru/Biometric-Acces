...
<%@ page import="com.oreilly.servlet.*"%>
            ...
            <%
					...
					if ( rs1.next() )
					   {
					   		out.print("Client Name Already Exist");
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,pincode,status,image,thumbimage,thumbname) values(?,?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0)
						{
							out.print("Client Registered Successfully");
