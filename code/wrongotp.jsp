...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style8">Your OTP is Wrong </span>!!! Pls Login Again !!! </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img">
            <form action="ClientAuthentication.jsp" method="post" id="leavereply">
              <ol>
                <li class="style8">
                ...
                </span><span class="style9"><strong><label for="email"></label>
